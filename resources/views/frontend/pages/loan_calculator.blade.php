...
@section('content')
    ...
    <section class="relative bg-[#050a15] pt-[110px] pb-10 lg:pt-32 lg:pb-20 overflow-hidden border-b border-white/5">
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_rgba(74,222,128,0.1)_0%,_transparent_40%)]"></div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
                        ...
                        <span class="text-[10px] uppercase tracking-[0.3em] text-slate-300 font-bold">Finance Intelligence</span>
                    </div>
                    ...
                    <p class="text-slate-400 text-base md:text-lg max-w-lg font-medium leading-relaxed">
                        ...
                        <span class="text-white font-bold italic underline decoration-[#4ade80]/30">monthly investment</span> in real-time.
                    </p>

                    <div class="flex items-center gap-8 pt-4 border-t border-white/5 text-left">
                        <div>
                            <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Interest Rates From</p>
                        ...
                        <div>
                            ...
                            <p class="text-xl font-black text-white">84 <span class="text-slate-500 text-sm italic font-medium">Months</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden lg:block">
                    <div class="relative group">
                        <div class="absolute -inset-1 bg-gradient-to-r from-[#4ade80]/20 to-blue-500/20 rounded-3xl blur opacity-75 group-hover:opacity-100 transition duration-1000"></div>
                        <div class="relative bg-white/5 border border-white/10 backdrop-blur-2xl rounded-3xl p-8">
                            <div class="flex justify-between items-start mb-8">
                                <div>
                                    <h3 class="text-white font-black uppercase italic text-sm tracking-wider">Algorithmic Precision</h3>
                                    <p class="text-slate-500 text-[11px] font-bold uppercase tracking-tight">Real-time Amortization Engine</p>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="w-full bg-white/5 h-1.5 rounded-full overflow-hidden">
                                    <div id="progressBar" class="bg-[#4ade80] h-full w-[0%] transition-all duration-700 shadow-[0_0_10px_rgba(74,222,128,0.5)]"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                ...
                <div class="lg:col-span-7">
                    <div class="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-sm h-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            <div class="space-y-2">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Asset Value (NRs)</label>
                                <div class="relative group">
                                    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs group-focus-within:text-green-600 transition-colors">NRs</span>
                            ...
                            <div class="space-y-2">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Down Payment (NRs)</label>
                                <div class="relative group">
                                    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs group-focus-within:text-green-600 transition-colors">NRs</span>
                            ...
                            <div class="space-y-2">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Interest APR (%)</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Tenure Window</label>
                                <div class="relative">
                        ...
                        <div class="mt-8 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                           <div class="flex items-center gap-3">
                               ...
                               <p class="text-[10px] text-slate-500 font-bold uppercase tracking-tight">Pro Tip: Increasing your down payment by 10% can significantly reduce your total interest paid.</p>
                           </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5">
                    <div id="loanResult" class="bg-slate-900 rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl h-full flex flex-col justify-center transition-all duration-500 border border-slate-800">
                        <div class="relative z-10">
                            <span class="text-[10px] font-black text-[#4ade80] uppercase tracking-[0.4em] mb-4 block">Monthly Investment</span>
                            
                            <div class="flex items-baseline gap-2 mb-2">
                                <span class="text-xl font-bold opacity-30 text-slate-400">NRs</span>
                                <span id="monthlyEMI" class="text-5xl font-black italic tracking-tighter leading-none text-white animate-in fade-in zoom-in duration-500">----</span>
                            </div>
                            
                            <p id="emiDetails" class="text-slate-500 text-[10px] font-bold uppercase tracking-[0.2em]">Awaiting input...</p>

                            <div class="mt-10 space-y-6 pt-8 border-t border-white/5">
                                <div class="flex justify-between items-center group">
                                    <span class="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] group-hover:text-slate-300 transition-colors">Principal Amount</span>
                                    <span id="loanAmount" class="text-sm font-black text-slate-400 italic">----</span>
                                </div>
                                <div class="flex justify-between items-center group">
                                    <span class="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] group-hover:text-slate-300 transition-colors">Interest Payload</span>
                                    <span id="totalInterest" class="text-sm font-black text-slate-400 italic">----</span>
                                </div>
                                <div class="flex justify-between items-center group">
                                    <span class="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] group-hover:text-slate-300 transition-colors">Total Repayment</span>
                                    <span id="totalRepayment" class="text-sm font-black text-[#4ade80] italic">----</span>
                                </div>
                            </div>
                        </div>

                        <div id="glowEffect" class="absolute -bottom-20 -right-20 w-64 h-64 bg-green-500/10 rounded-full blur-[100px] transition-all duration-1000"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pb-24 bg-[#f8fafc]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    <div class="w-12 h-12 bg-green-50 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m.5-1c.28 0 .551-.024.811-.07M12 16c-1.11 0-2.08-.402-2.599-1M12 16v1m-1.5-1c-.28 0-.551-.024-.811-.07" />
                        </svg>
                    </div>
                    <h3 class="text-sm font-black text-slate-900 uppercase tracking-widest mb-3">The Principal</h3>
                    <p class="text-slate-500 text-sm leading-relaxed font-medium">
                        In car financing, the <span class="text-slate-900 font-bold">Principal</span> is the actual amount of money you borrow from the lender. It is calculated by taking the vehicle's "On-Road" price and subtracting your Down Payment. Every EMI you pay goes toward reducing this balance and covering the interest.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-sm font-black text-slate-900 uppercase tracking-widest mb-3">Annual Percentage Rate</h3>
                    <p class="text-slate-500 text-sm leading-relaxed font-medium">
                        The <span class="text-slate-900 font-bold">APR</span> represents the annual cost of your loan, including interest and certain fees. In Nepal, vehicle loan rates are often "Floating," meaning they can adjust based on the bank's base rate. A lower APR directly results in a lower Total Repayment amount.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed font-medium">
                        Tenure is the duration of your loan. While a <span class="text-slate-900 font-bold">longer tenure</span> (e.g., 7-8 years) makes your monthly EMI more affordable, it increases the <span class="text-slate-900 font-bold">Total Interest</span> paid over time. Balancing your monthly budget with the total cost of ownership is key.
                    </p>
                </div>
                ...
                <div class="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="space-y-4 text-slate-400 text-sm font-medium leading-relaxed">
                            <p>
                                Amortization is the process of spreading out a loan into a series of fixed payments. At the beginning of your loan term, a larger portion of your EMI goes toward paying off the <span class="text-white">Interest</span>. 
                            </p>
                            <p>
                                As the principal balance decreases over time, the interest portion of your payment shrinks, and more of your money goes toward the <span class="text-white">Principal</span>. This is why paying off a loan early can save you a significant amount in interest charges.
                            </p>
                            <div class="pt-4 flex gap-4">
                                <div class="px-4 py-2 bg-white/5 border border-white/10 rounded-xl">
                                    <span class="block text-[10px] text-slate-500 uppercase font-black tracking-widest">Calculated using</span>
                    ...
                    <div class="relative">
    <div class="aspect-video bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-8 flex flex-col justify-between overflow-hidden group">
        
        <div class="flex items-end justify-between gap-1 h-32 mb-4">
            <div class="w-full bg-white/5 rounded-t-sm h-[90%] relative group-hover:bg-[#4ade80]/20 transition-all duration-500"></div>
            ...
            <div class="w-full bg-[#4ade80]/40 rounded-t-sm h-[15%] shadow-[0_0_15px_rgba(74,222,128,0.3)]"></div>
        </div>

        <div class="space-y-4">
            <div class="flex justify-between items-end">
                <div>
                    <p class="text-[10px] font-black text-[#4ade80] uppercase tracking-widest">Efficiency Trend</p>
                    <p class="text-white text-lg font-bold italic tracking-tighter leading-none">+12.5% <span class="text-slate-500 text-[10px] not-italic font-medium">Equity Gain/Year</span></p>
                </div>
                <div class="text-right">
                    <svg class="w-8 h-8 text-white/20 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="pt-4 border-t border-white/10 flex justify-between">
                <div class="flex gap-2 items-center">
                    ...
                    <span class="text-[8px] font-black text-slate-400 uppercase tracking-tighter">Principal</span>
                </div>
                <div class="flex gap-2 items-center">
                    <div class="w-2 h-2 rounded-full bg-blue-500"></div>
                    <span class="text-[8px] font-black text-slate-400 uppercase tracking-tighter">Interest Paid</span>
                </div>
            </div>
        </div>

        <div class="absolute inset-0 pointer-events-none opacity-10">
            <div class="h-full w-full" style="background-image: linear-gradient(#fff 1px, transparent 1px), linear-gradient(90deg, #fff 1px, transparent 1px); background-size: 20px 20px;"></div>
        </div>
    </div>

    <div class="absolute -top-12 -right-12 w-64 h-64 bg-[#4ade80]/10 rounded-full blur-[100px] animate-pulse"></div>
    ...
    <script>
        ...
        function calculateLoan() {
            ...
            if (principal > 0 && monthlyRate > 0) {
                // Amortization Formula: [P x r x (1+r)^n] / [(1+r)^n - 1]
                ...
                // UI Injection
                updateUI(emi, principal, totalInterest, totalRepayment, tenureMonths, rawInterest);
            } else {
                resetUI();
            }
        }
