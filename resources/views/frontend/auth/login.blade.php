...
<head>
    ...
    <style>
        /* Ensuring no scroll on the body */
        ...
        <section class="w-full lg:w-[45%] h-full flex flex-col justify-center px-8 md:px-16 bg-white relative z-10 shadow-2xl overflow-y-auto no-scrollbar">
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    <button class="flex items-center justify-center gap-2 py-3 border border-slate-200 rounded-xl hover:bg-slate-50 transition-all">
                ...
                <form action="#" class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <div class="relative group">
                            <input type="email" placeholder="name@company.com" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm focus:outline-none focus:border-[#16a34a] focus:bg-white transition-all font-medium">
                        </div>
                    </div>
                    ...
                    <div class="space-y-1">
                        <div class="flex justify-between items-center ml-1">
                            ...
                            <a href="#" class="text-[9px] font-black text-[#16a34a] hover:underline uppercase tracking-widest">Forgot?</a>
                        </div>
                        <input type="password" placeholder="••••••••" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 px-4 text-sm focus:outline-none focus:border-[#16a34a] focus:bg-white transition-all font-medium">
                    </div>

                    <div class="flex items-center gap-2 px-1 py-1">
                        <input type="checkbox" id="remember" class="w-4 h-4 rounded border-slate-300 text-[#16a34a] focus:ring-[#4ade80]">
                        <label for="remember" class="text-[11px] font-bold text-slate-500 cursor-pointer">Stay signed in</label>
                    </div>

                    <button class="w-full py-4 bg-slate-900 text-white rounded-xl font-black uppercase italic tracking-widest text-xs hover:bg-[#16a34a] transition-all flex items-center justify-center gap-3 shadow-xl shadow-slate-200">
                        Authorize Entry
            ...
            <p class="mt-8 text-center text-[11px] font-bold text-slate-400 uppercase tracking-widest">
                New to the community? <a href="#" class="text-[#16a34a] hover:underline ml-1">Join Now</a>
            </p>
        </section>
