...
<div class="flex min-h-screen">
    ...
    <aside class="w-60 bg-slate-900 flex flex-col fixed inset-y-0 z-40">
        ...
        <div class="px-5 py-4 border-b border-slate-700">
            ...
            <span class="inline-block mt-1 text-[10px] px-2 py-0.5 rounded-full font-black uppercase tracking-wider bg-blue-500/10 text-blue-400 border border-blue-500/20">
                Seller
            </span>
        </div>
    ...
    <div class="flex-1 ml-60">
        ...
        {{-- Flash messages --}}
        @if(session('success'))
            <div class="mx-8 mt-5 bg-[#4ade80]/10 border border-[#4ade80]/30 text-[#16a34a] rounded-xl px-4 py-3 text-sm font-bold">
                {{ session('success') }}
            </div>
        @endif
        @if(session('error'))
