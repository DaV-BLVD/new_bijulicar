    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white border border-slate-200 rounded-2xl p-6">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">Your Review</p>
            ...
            <div class="bg-white border border-slate-200 rounded-2xl p-6">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-slate-400 font-medium mt-1">{{ $car->location }}</p>
                        @if($car->range_km)
                        <p class="text-[11px] font-black text-[#16a34a] mt-1">⚡ {{ $car->range_km }} km range</p>
                        @endif
                    </div>
                </div>
