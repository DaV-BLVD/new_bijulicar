        ...
        <form method="POST" action="{{ route('business.advertisements.store') }}" enctype="multipart/form-data">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-5">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-slate-400 font-medium mt-1">JPG, PNG or WebP — max 2MB. Recommended: 1200×400px.</p>
                ...
                <div>
                    ...
                    <select name="placement"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-400 outline-none transition-all appearance-none">
                        <option value="marketplace" {{ old('placement') === 'marketplace' ? 'selected' : '' }}>Marketplace</option>
                        <option value="home"        {{ old('placement') === 'home'        ? 'selected' : '' }}>Home Page</option>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1.5">Start Date <span class="text-slate-400 font-medium normal-case tracking-normal">(optional)</span></label>
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1.5">End Date <span class="text-slate-400 font-medium normal-case tracking-normal">(optional)</span></label>
